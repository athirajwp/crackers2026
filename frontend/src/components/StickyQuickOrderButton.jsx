...
export default function StickyQuickOrderButton() {
  ...
  return (
    <div className={`fixed right-3 sm:right-6 ${bottomClass} z-50 transition-all duration-300 select-none print:hidden`}>
      <Link
        to="/quick-order"
      ...
      >
        <img
          src={getImageUrl('/img/shop_now.png')}
          ...
          onError={(e) => {
            ...
            e.target.src = getImageUrl('/img/quickpurchase.png');
          }}
        />
      </Link>
    </div>
